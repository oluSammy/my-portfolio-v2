      ...
      <div className="container px-2 md:px-0 mx-auto grid grid-cols-12 gap-0 md:gap-10 ">
        <div className="md:col-span-6 col-span-12">
          ...
          <div className="mt-12 px-2">
            <p className="text-black lg:text-xl text-sm font-extralight font-outfit text-justify">
            ...
            <p className="text-black lg:text-xl text-sm font-extralight font-outfit text-justify mt-8">
        ...
        <div className="md:col-span-6 col-span-12 md:mt-0 mt-20 flex justify-center items-center">
          <figure className="h-[600px] md:w-[500px] sm:w-[350px] w-[310px]">
            <div className="h-full w-full bg-black rounded-2xl">
              <Image
                ...
                width={500}
                height={500}
                className="h-full w-full object-cover rounded-2xl md:translate-x-4 -translate-y-4"
              />
            </div>
          </figure>
        </div>
